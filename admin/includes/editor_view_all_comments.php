            ...
            <?php 
                ...
                while($row = mysqli_fetch_assoc($select_comments)) {
                    ...
                    echo "<tr>
                            ...
                            <td>{$comment_date}</td>
                            <td><a href='editor_comments.php?approve={$comment_id}'>Approve</a></td>
                            <td><a href='editor_comments.php?unapprove={$comment_id}'>Unapprove</a></td>
                            <td><a href='editor_comments.php?delete={$comment_id}'>Delete</a></td>
                          </tr>";
...
if(isset($_GET['approve'])){
    ...
    if(isset($_SESSION['user_id'])) {
        ...
        if($user_role !== 'editor') {
            ...
            echo '<META HTTP-EQUIV="Refresh" Content="0; URL=editor_comments.php">';
        }
    } 
